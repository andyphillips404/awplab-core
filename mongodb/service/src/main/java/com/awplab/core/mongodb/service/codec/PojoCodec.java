...
import com.awplab.core.mongodb.service.PojoCodecInclude;
import com.awplab.core.mongodb.service.PojoCodecKey;
import com.awplab.core.mongodb.service.PojoCodecProperties;
import org.bson.*;
...
public class PojoCodec<T> implements CollectibleCodec<T> {
    ...
    public Map<String, Object> getSetKeyLookup() {
        return setKeyLookup;
    }

    public Map<String, Object> getGetKeyLookup() {
        return getKeyLookup;
    }

    public Map<String, PojoCodecInclude> getKeyIncludeLookup() {
    ...
    public PojoCodec(Class<T> type, Codec<Document> documentCodec) {
        ...
        for (Field field : type.getFields()) {
            ...
            if (pojoCodecKey != null) {
                ...
                translateBeanToDatabase.put(field.getName(), key);
        ...
        for (Method method : type.getMethods()) {
            ...
            if (!method.getReturnType().equals(Void.TYPE) && method.getParameterCount() == 0 && (method.getName().startsWith("get") || method.getName().startsWith("is"))) {
                ...
                if (pojoCodecKey != null) {
                    ...
                    translateBeanToDatabase.put(methodKey, key);
                    ...
                    if (autoDetectMethods) {
                        ...
                        translateBeanToDatabase.put(methodKey, methodKey);
