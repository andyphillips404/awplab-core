 ...
 */
@Command(scope = "scheduler", name = "delete")
@Service
public class DeleteCommand implements Action {
    ...
    public Object execute() throws Exception {
        ...
        if (!schedulerManagerService.deleteJob(schedulerName, jobKey)) {
            throw new IllegalArgumentException("Scheduler or job not found");
        }
