...
public class JobsCommand implements Action {
    ...
    public Object execute() throws Exception {
        ...
        for (Scheduler scheduler : schedulerManager.getSchedulers()) {
            ...
            //String localSchedulerName = schedulerManager.getSchedulerName(scheduler);
            ...
            for (String group : scheduler.getJobGroupNames()) {
                ...
                for (JobKey jobKey : scheduler.getJobKeys(GroupMatcher.<JobKey>groupEquals(group))) {
                    ...
                    System.out.println("Running: " + (schedulerManager.getRunningJob(scheduler.getSchedulerName(), jobKey) != null ? "Yes" : "No"));
